...
\caption{List of methods in mixOmics, sparse indicates methods that perform variable selection}(\#fig:methods)
\end{figure}
...
\caption{Main functions and parameters of each method}(\#fig:cheatsheet)
\end{figure}
