...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{selectVar}\NormalTok{(MyResult.spca, }\DataTypeTok{comp=}\DecValTok{2}\NormalTok{)}\OperatorTok{$}\NormalTok{value}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{selectVar}\NormalTok{(MyResult.splsda, }\DataTypeTok{comp=}\DecValTok{1}\NormalTok{)}\OperatorTok{$}\NormalTok{name             }\CommentTok{# Selected variables on component 1}
\end{Highlighting}
\end{Shaded}
